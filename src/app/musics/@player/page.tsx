...
const Player = () => {
  return (
    <div className="fixed bottom-0 left-[35%] w-[40rem] bg-[#171717] p-4 flex items-center justify-between text-white">
        <div className="w-16 h16 bg-gray-700 rounded-md"></div>
        ...
        <div className="flex items-center gap-4 text-gray-400">
            <span>6:69</span>
            <div className="relative w-64 h-1 bg-gray0700 rounded-md">
                <div className="absolute top-0 left-0 h-1 bg-white rounded-md" 
                style={{width:"50%"}}/>
                <input type="range"
